...
class Modification(Order):
    ...
    def __repr__(self):
        return f'Modification(agent_id={self.agent_id}, order_id={self.order_id}, volume={self.volume}, time={self.time})'
...
class LimitOrderBook:
    ...
    def log_to_df(self):
        try:
            ...
            raise RuntimeError("pandas is required for log_to_df but could not be imported") from exc
